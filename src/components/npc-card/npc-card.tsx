...
function NpcGenderIcon(props) {
	if (props.gender == 'Male') {
		return (
			<svg className="npc-card__gender-symbol" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1506 1506.0001" enable-background="new 0 0 1506 1506.0001" xmlSpace="preserve">
		...
		return (
			<svg className="npc-card__gender-symbol" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="1582.8676 -62.4635 987.1324 1679.4772" enable-background="new 1582.8676 -62.4635 987.1324 1679.4772" xmlSpace="preserve">
